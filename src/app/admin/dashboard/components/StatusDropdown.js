	...
	return (
		<Menu as='div' className='relative inline-block text-left'>
			...
			<MenuItems
				transition
				anchor='bottom end'
				className='w-40 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50 transition duration-100 ease-out data-[closed]:scale-95 data-[closed]:opacity-0'>
