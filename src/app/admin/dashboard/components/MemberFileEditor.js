		...
		<div className='bg-white/60 backdrop-blur-sm border border-gray-200 rounded-lg p-5 shadow-inner space-y-6'>
			...
			<div className='flex flex-col sm:flex-row gap-2'>
				<label className='w-full relative cursor-pointer'>
					...
					/>
					<div className='flex items-center justify-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 text-sm font-medium rounded-md border border-blue-200 hover:bg-blue-100'>
						{isUploading ? (
