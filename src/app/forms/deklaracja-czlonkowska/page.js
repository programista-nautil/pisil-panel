		...
		<div className='min-h-screen bg-gray-50'>
			...
			<div className='max-w-4xl mx-auto py-8 px-4'>
				<header className='text-center mb-8'>
					<h1 className='text-3xl font-bold text-[#005698] mb-2'>Deklaracja Członkowska PISiL</h1>
					<p className='text-gray-600'>Formularz członkowski dla firm - Polska Izba Spedycji i Logistyki</p>
