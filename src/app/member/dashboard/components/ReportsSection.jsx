...
const REPORTS_DATA = [
    ...
    },
    {
        year: '2018',
        files: [
            'Sprawozdanie 2018 (strony 72–89).pdf',
    ...
    },
    {
        ...
        files: [
            'Całościowy wykaz publikacji.xls',
            'Lista publikacji.xlsx'
        ]
    }
]
        ...
        <section className='mb-8'>
            ...
            >
                <div className='flex items-center gap-3'>
                    ...
                    <h2 className='text-lg font-semibold text-[#005698]'>Sprawozdania i Publikacje</h2>
                </div>
            ...
            {isMainOpen && (
                <div className='mt-2 bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden divide-y divide-gray-200 pl-4 border-l-4 border-l-[#005698]'>
                    {reportCategories.map(category => (
                        <CollapsibleFileCategory key={category.category} category={category} />
                    ))}
                </div>
            )}
        </section>
